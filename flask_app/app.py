...
# Define your custom metrics using this registry --> use to track matrics on promth.
...
# ------------------------------------------------------------------------------------------
# Model and vectorizer setup --> gets the latest model from 'Stagging phase' from MLflow
model_name = "my_model"
...
@app.route("/predict", methods=["POST"])  # Logic after pressing predict button.
def predict():
    REQUEST_COUNT.labels(method="POST", endpoint="/predict").inc()
    start_time = time.time() # --> added for latency calculation

    text = request.form["text"]  # capturing the input text
    # Clean text
    text = normalize_text(text) # input text can have @#$% link etc, to clean that we have written this funt
    # Convert to features
